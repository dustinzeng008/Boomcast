...
@interface YZHottestViewController ()<UITableViewDelegate, UITableViewDataSource,
...
@implementation YZHottestViewController
...
- (void)viewDidLoad {
    ...
    [self loadHottestBroadcast];
}

- (void)loadHottestBroadcast{
    _broadcastFrames = [[NSMutableArray alloc] init];
    [MBProgressHUD showHUDAddedTo:self.view animated:YES];
    FIRDatabaseQuery *query = [[self.databaseRef child:@"broadcasts"] queryOrderedByChild:@"onlineNumber"];
